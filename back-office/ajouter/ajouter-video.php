...
?>
  <header>
        ...
        <main>
		  ...
		  <form action="../actions/ajouter-video.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-haut">
                    <div class="form-gauche">
                        ...
                        <p class="input_label">
                            ...
                            <input type="text" name="exercice" required>
                        </p>
                    ...
                    <div class="form-droite">
					  ...
					  <p class="input_label">
						...
						<input type="time" name="duration" step="2" max="01:00:00" required>
					  </p>
