...
?>
    ...
    $placeholder = "SELECT * FROM `admin` WHERE id_admin=:id_admin";
    $stmt2 = $db->prepare($placeholder);
    $stmt2->bindParam(':id_admin', $_GET["id"], PDO::PARAM_INT);
    $stmt2->execute();
    ...
    <main>
        <a class="retour" href="../comptes-admin.php?order=0&by=id_user">Retour</a>
        <?php
        echo "<p>Vous souhaitez <a class='btn3' href='../actions/modifier-admin.php?id={$placeholder["id_admin"]}' >supprimer l'admin</a>.";
        ?>
